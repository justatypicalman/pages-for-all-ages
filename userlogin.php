...
<body>
	<div class="d-flex justify-content-center align-items-center"
		...
		<form class="p-5 rounded shadow"
		      ...
		      method="POST"
		      action="php/user-auth.php" data-aos="flip-up" data-aos-duration="1800">
			  <a href="login.php"><input type="button" value="Login as Admin" class="btn" style="color: white; position: absolute; top:10px; right: 10px;"></a>
	<div style="display: inline">
		  <h1 class="text-center display-4 pb-5"><i style="color: #F68901;font-size: 50px;" class="fa-solid fa-user"></i> User Login</h1></div>
